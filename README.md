# `librealsense_jll.jl` (v2.36.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/9df74f7c54fe7b3a7901f4516e22173cbf50d0fc/L/librealsense/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/IntelRealSense/librealsense.git (revision: `f7cdf6e8961e1709f6d864bdb33095c00a671ca7`)
