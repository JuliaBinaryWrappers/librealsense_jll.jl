...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import librealsense_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("65edd895-dc1e-518e-896c-dc343a3c7f2e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "librealsense", artifacts_toml) for e in artifacts["librealsense"]]
...
if best_platform === nothing
    @debug("Unable to load librealsense; unsupported platform $(triplet(platform_key_abi()))")
else
